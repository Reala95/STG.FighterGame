...
public class Player_PlayerFighterObject : Common_FighterObject
{
    ...
    UI_HealBar healBar;
    System_GameManager gameManager;

    AudioSource hitSE;
    AudioSource killedSE;
    ...
    private void Awake()
    {
        ...
        gameManager = GameObject.FindGameObjectWithTag(uiManager).GetComponent<System_GameManager>();
        gameManager.setPauseAble(false);

        hitSE = GameObject.FindGameObjectWithTag(uiSEManager).GetComponents<AudioSource>()[fighterHitSE];
        killedSE = GameObject.FindGameObjectWithTag(uiSEManager).GetComponents<AudioSource>()[fighterKilledSE];
    }
